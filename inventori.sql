...
CREATE TABLE `barang` (
  ...
  `id_pemegang` int(50) NOT NULL,
  `tgl_beli` date NOT NULL,
  `kondisi_barang` enum('Barang Bekas(BB)','Brand New(BN)','','') NOT NULL
...
CREATE TABLE `jabatan` (
  ...
  `status` enum('Full time','Magang') NOT NULL,
  `gaji_pokok` int(15) NOT NULL,
  `tgl_gaji` date NOT NULL,
  `kenaikan_gaji` int(15) NOT NULL,
...
INSERT INTO `jabatan` (`id_jabatan`, `nama_jabatan`, `divisi`, `job_desc`, `status`, `gaji_pokok`, `tgl_gaji`, `kenaikan_gaji`, `tgl_naik_gaji`) VALUES
(1, 'Head of Marketing', 'Marketing', 'Promotion, Events, Social Media', 'Full time', 4500000, '2021-01-01', 0, '0000-00-00'),
(2, 'Head of IT', 'IT', 'Mobile Apps, Desktop Apps, UI/UX', 'Full time', 8000000, '2021-01-01', 0, '0000-00-00');
...
CREATE TABLE `karyawan` (
  ...
  `email_pribadi` varchar(50) DEFAULT NULL,
  `email_corporate` varchar(50) DEFAULT NULL,
  `nomor_hp` char(14) DEFAULT NULL,
  `nomor_telp_rmh` char(14) DEFAULT NULL,
  `status` enum('Single','Menikah','Cerai') NOT NULL,
  `jml_anak` char(2) DEFAULT NULL,
...
INSERT INTO `karyawan` (`id`, `nik`, `nama`, `jenis_kelamin`, `tempat_lahir`, `tgl_lahir`, `alamat`, `kode_pos`, `provinsi`, `kabupaten`, `kecamatan`, `email_pribadi`, `email_corporate`, `nomor_hp`, `nomor_telp_rmh`, `status`, `jml_anak`, `tgl_masuk`, `pas_foto`, `foto_ktp`, `foto_kk`, `foto_npwp`, `id_jabatan`) VALUES
(1, '3509211100', 'user1', 'Laki-Laki', 'Surabaya', '1996-08-08', 'Siwalankerto', '', 0, 0, 0, '', '', NULL, NULL, 'Single', '0', '2020-10-01', '', '', '', '', 1);
...
(1, 'Elektronik', 'Perangkat elektronik seperti terminal, komputer, dll.'),
(2, 'Perkakas', 'Peralatan seperti gergaji, tang, obeng, dll'),
(3, 'ATK', 'Barang berupa alat-alat tulis');
...
INSERT INTO `laboratorium` (`id_lab`, `nama_lab`, `lokasi`) VALUES
(1, 'Lab SI', 'Gedung P lantai 2'),
(2, 'Lab PG', 'Gedung P lantai 2'),
(3, 'Lab MM', 'Gedung P lantai 2');
...
INSERT INTO `stok_barang` (`id_barang`, `kode_barang`, `nama_barang`, `stok_barang`, `tgl_masuk`, `foto`, `id_jenis`, `id_lab`, `status`) VALUES
(1, 'BRG001', 'Printer Epson L3110', 5, '2020-06-03', '06072020115334printer.jpg', 1, 1, 'Berfungsi baik'),
(2, 'BRG002', 'PC Acer 15 inch', 20, '2020-06-04', '06072020115941pc.jpg', 1, 2, 'Berfungsi baik'),
(3, 'BRG003', 'Terminal 5 port', 15, '2020-06-10', '06072020120001terminal.jpg', 2, 3, 'Berfungsi baik'),
(4, 'BRG004', 'Mouse Logitech', 20, '2020-06-16', '06072020120011logitech.jpg', 1, 2, 'Berfungsi baik'),
(5, 'BRG005', 'Printer Epson L3150', 5, '2020-06-30', '08072020120132printer.png', 1, 1, 'Berfungsi baik'),
(6, 'BRG006', 'Modem ZTE F660', 1, '2020-07-09', 'modem.jpg', 1, 3, 'Berfungsi baik');
...
INSERT INTO `user` (`id_user`, `username`, `name`, `password`, `email`, `telepon`, `role`) VALUES
(1, 'admin', 'Richard', 'admin', 'richardputras@gmail.com', 0, 'Admin'),
(2, 'kepala1', 'Jess', 'kepala', 'jess@gmail.com', 0, 'Kepala divisi');
...
--
ALTER TABLE `laboratorium`
  MODIFY `id_lab` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `stok_barang`
  ADD CONSTRAINT `stok_barang_ibfk_1` FOREIGN KEY (`id_jenis`) REFERENCES `kategori` (`id_kategori`),
  ADD CONSTRAINT `stok_barang_ibfk_2` FOREIGN KEY (`id_lab`) REFERENCES `laboratorium` (`id_lab`);
COMMIT;
