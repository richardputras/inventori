...
--
-- Host: localhost:3306
-- Generation Time: Mar 17, 2021 at 02:59 AM
...
CREATE TABLE `barang` (
  ...
  `eks_harga_jual` int(15) NOT NULL,
  `deskripsi` longtext NOT NULL,
  `foto` varchar(255) NOT NULL,
  `qty` int(11) NOT NULL,
  `satuan` enum('Unit','Pcs','Box','DLL') NOT NULL,
  `qr_code` varchar(255) NOT NULL,
  `tgl_bayar` date NOT NULL,
  `tgl_terima` date NOT NULL,
  `kondisi_barang` enum('Berfungsi baik','Perlu perbaikan','Proses perbaikan','Rusak') NOT NULL,
  `status_barang` enum('Beli baru','Beli bekas','Hibah baru','Hibah bekas','Perlu dijual','Terjual') NOT NULL,
...
INSERT INTO `barang` (`id_barang`, `kode_barang`, `nama_barang`, `harga_beli`, `harga_jual`, `eks_harga_jual`, `deskripsi`, `foto`, `qty`, `satuan`, `qr_code`, `tgl_bayar`, `tgl_terima`, `kondisi_barang`, `status_barang`, `jadwal_perbaikan`, `garansi`, `id_pemegang`, `id_supplier`) VALUES
(5, '', 'Laptop Programmer', 9756500, 0, 0, 'Merk: ASUS A409PJ 14\"\r\nProcessor: Core i5\r\nRAM: DDR4 8GB\r\nROM: HDD 1TB \r\nSSD M2 Nvme 256GB\r\nWin 10 Home', '', 1, 'Unit', '', '2020-09-14', '2020-09-17', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 2, 1),
(6, '', 'Personal Computer (PC)', 13275000, 0, 0, 'Warna hitam', '', 1, 'Unit', '', '2020-10-03', '2020-10-03', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 1),
(7, '', 'LED Lamp', 57500, 0, 0, 'Merk: Philips 14 Watt, dipasang di studio', '', 8, 'Unit', '', '2020-10-10', '2020-10-10', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 16),
(8, '', 'Video LED', 1435000, 0, 0, 'Merk: Godox SL-60W \r\nBerat: 3 kg\r\nDimensi: 25x12x13cm\r\nCahaya Putih: 5600K\r\nInclude Tripod', '', 1, 'Unit', '', '2020-10-11', '2020-10-11', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 9),
(10, '', 'Kain Green Screen', 285000, 0, 0, 'Ukuran: 2,4x6 m\r\nBerat: 3 kg\r\nBahan: Polyester', '', 1, 'Unit', '', '2020-10-11', '2020-10-14', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 12),
(11, '', 'Softbox Studio', 136100, 0, 0, 'Ukuran: 50x70 cm\r\nBerat: 4.2 kg\r\nTanpa tripod', '', 2, 'Unit', '', '2020-10-11', '2020-10-14', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 8),
(12, '', 'Teleprompter', 250000, 0, 0, 'Merk: ARTechno DIY\r\nBerat: 1.2 kg\r\nPanjang: 40cm', '', 1, 'Unit', '', '2020-10-11', '2020-10-11', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 10),
(13, '', 'Tether Tools/Case Relay Camera', 1984000, 0, 0, 'Berat: 500gr\r\nBaterai: Lithium 1200 mAh', '', 1, 'Unit', '', '2020-10-11', '2020-10-14', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 13),
(14, '', 'Light Stand', 215000, 0, 0, 'Merk: Takara Spirit 2\r\nBerat: 4 kg\r\nTinggi Max: 220cm\r\nTinggi Min: 90cm\r\nDaya tampung: Max 5 kg', '', 2, 'Unit', '', '2020-10-11', '2020-10-11', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 11),
(15, '', 'Klip Jepit Backdrop', 11500, 0, 0, 'Dimensi: 6 inch 9x16cm\r\nUkuran: 3 cm', '', 6, 'Unit', '', '2020-10-11', '2020-10-11', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 14),
(16, '', 'Personal Computer (PC)', 12675000, 0, 0, 'Warna putih', '', 1, 'Unit', '', '2020-10-23', '2020-10-27', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 1),
(17, '', 'USB Wifi TP-Link', 100000, 0, 0, 'Speed: 300Mbps', '', 1, 'Unit', '', '2020-10-23', '2020-10-27', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 1),
(18, '', 'Hydro Cooling', 600000, 0, 0, 'Untuk pendingin PC', '', 1, 'Unit', '', '2020-10-23', '2020-10-27', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 1),
(19, '', 'Stavolt', 500000, 0, 0, 'Merk: Minamoto\r\nKapasitas: 500 VA\r\nDimensi: 210 x 180 x 135 mm', '', 1, 'Unit', '', '2020-10-23', '2020-10-27', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 1),
(20, '', 'Kabel Audio', 25000, 0, 0, 'Ukuran: 3,5 mm\r\nPanjang: 5 m', '', 1, 'Unit', '', '2020-11-01', '2020-11-01', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 1),
(21, '', 'Busa Peredam', 170000, 0, 0, 'Untuk bilik dubbing', '', 1, 'Unit', '', '2020-10-30', '2020-11-04', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 15),
(22, '', 'Mic Studio', 1620000, 0, 0, 'Merk: Boya BY-WM4 PRO K2', '', 1, 'Unit', '', '2020-10-11', '2020-10-11', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 11),
(23, '', 'iPhone SE', 9000000, 0, 0, 'RAM 3 GB \r\nROM 128 GB', '', 1, 'Unit', '', '2020-11-26', '2020-11-26', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 10, 4),
(24, '', 'Xiaomi Redmi Note 9', 2800000, 0, 0, 'RAM 6 GB \r\nROM 128 GB', '', 2, 'Unit', '', '2020-11-27', '2020-11-27', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 8, 4),
(25, '', 'Windows 10 ORI', 1800000, 0, 0, 'Windows 10 Professional 64bit OEM (untuk PC putih)', '', 1, 'Unit', '', '2020-12-14', '2020-12-14', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 1),
(26, '', 'HDMI Capture Video Card', 290000, 0, 0, '', '', 1, 'Unit', '', '2020-12-22', '2020-12-22', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 20),
(27, '', 'Kain Green Screen', 265625, 0, 0, 'Ukuran: 2,4x5 m\r\nBerat: 3 kg\r\nBahan: Polyester', '', 1, 'Unit', '', '2020-12-21', '2020-12-27', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 12),
(28, '', 'Windows 10 ORI', 1800000, 0, 0, 'Windows 10 Professional 64bit OEM (untuk PC hitam)', '', 1, 'Unit', '', '2021-01-18', '2021-01-18', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 1),
(29, '', 'USB Hub 4 Port 2.0', 100000, 0, 0, 'Merk: Targus', '', 1, 'Unit', '', '2021-01-18', '2021-01-18', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 3),
(30, '', 'Meja Kerja', 375000, 0, 0, 'Ukuran 50x100 cm\r\nTinggi 72 cm\r\nBerat 50 gr', '', 14, 'Unit', '', '2021-01-13', '2021-01-25', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 8, 6),
(31, '', 'Webcam', 1735000, 0, 0, 'Merk: Logitech C922 Pro', '', 1, 'Unit', '', '2021-01-14', '2021-01-14', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 1),
(32, '', 'Velcro Kretekan', 55000, 0, 0, '', '', 1, 'Unit', '', '2021-01-15', '2021-01-15', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 2),
(33, '', 'Mini Keyboard', 53900, 0, 0, 'Merk: Taffware RGB 2.4GHz\r\ndengan Touchpad\r\nBerat: 600gr', '', 2, 'Unit', '', '2021-02-08', '2021-02-08', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 8, 21),
(34, '', 'Kabel Adapter HDMI to VGA', 27900, 0, 0, 'Merk: Taffware HD008 White', '', 1, 'Unit', '', '2021-02-08', '2021-02-08', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 8, 21),
(35, '', 'USB Wifi TP-Link', 100000, 0, 0, 'Untuk PC hitam', '', 1, 'Unit', '', '2020-10-03', '2020-10-03', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 1),
(36, '', 'Hydro Cooling', 600000, 0, 0, 'Untuk PC hitam', '', 1, 'Unit', '', '2020-10-03', '2020-10-03', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 1),
(37, '', 'Stavolt', 500000, 0, 0, 'Minamoto 500VA, untuk PC hitam', '', 1, 'Unit', '', '2020-10-03', '2020-10-03', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 1),
(38, '', 'Kain Hitam', 350000, 0, 0, '', '', 1, 'Unit', '', '2020-10-09', '2020-10-09', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 1),
(39, '', 'iPad 3', 1500000, 0, 0, '', '', 1, 'Unit', '', '2020-12-04', '2020-12-04', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 10, 1),
(40, '', 'iPad 3', 1000000, 0, 0, '', '', 1, 'Unit', '', '2020-12-11', '2020-12-11', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 10, 1),
(41, '', 'Bracket TV', 182900, 0, 0, '', '', 1, 'Unit', '', '2020-12-21', '2020-12-21', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 8, 18),
(42, '', 'Bracket TV', 236000, 0, 0, '', '', 1, 'Unit', '', '2020-12-22', '2020-12-22', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 8, 19),
(43, '', 'Swivel with Wall Plate', 400000, 0, 0, '', '', 2, 'Unit', '', '2020-12-22', '2020-12-22', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 7),
(44, '', 'Kursi Kerja', 195000, 0, 0, '', '', 10, 'Unit', '', '2020-12-31', '2021-01-11', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 8, 1),
(45, '', 'Macbook Pro 2011 15\"', 10000000, 0, 0, 'Core i7\r\nRAM 16GB\r\nSSD 500GB SATA', '', 1, 'Unit', '', '2021-01-04', '2021-01-04', 'Berfungsi baik', 'Beli bekas', '0000-00-00', '', 19, 1),
(46, '', 'Portable DVD Writer', 350000, 0, 0, 'Merk: LG', '', 1, 'Unit', '', '2021-02-09', '2021-02-09', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 8, 1),
(47, '', 'Kabel HDMI', 75000, 0, 0, 'Panjang: 3m', '', 1, 'Unit', '', '2021-02-15', '2021-02-15', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 8, 1),
(48, '', 'Kabel Power CPU', 30000, 0, 0, '', '', 1, 'Unit', '', '2021-02-15', '2021-02-15', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 8, 1),
(49, '', 'Kabel HDMI', 85000, 0, 0, 'Panjang: 10m', '', 1, 'Unit', '', '2021-02-11', '2021-02-11', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 8, 3),
(50, '', 'Charger iPhone SE', 180000, 0, 0, '', '', 1, 'Unit', '', '2020-11-26', '2020-11-26', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 10, 4),
(51, '', 'Android TV', 2000000, 0, 0, 'Samsung 55 inch', '', 1, 'Unit', '', '2021-01-27', '2021-01-27', 'Rusak', 'Beli baru', '0000-00-00', '', 8, 2),
(52, '', 'Air Conditioner', 2994000, 0, 0, 'Merk: Gree 1 PK', '', 1, 'Unit', '', '2020-10-09', '2020-10-09', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 8, 5),
(53, '', 'Tripod', 160000, 0, 0, '', '', 1, 'Unit', '', '2020-12-10', '2020-12-10', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 19, 17),
(54, '', 'LED Lamp', 40000, 0, 0, 'Merk: Opple 12 Watt', '', 1, 'Unit', '', '2021-03-16', '2021-03-16', 'Berfungsi baik', 'Beli baru', '0000-00-00', '', 8, 22);

--
-- Triggers `barang`
--
DELIMITER $$
CREATE TRIGGER `after_insert_brg` AFTER INSERT ON `barang` FOR EACH ROW BEGIN
  INSERT INTO log (ket, user, new_data)
  VALUES (CONCAT('Insert data ke tabel barang, id = ', NEW.id_barang), USER(),NEW.nama_barang);
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `after_update_brg` AFTER UPDATE ON `barang` FOR EACH ROW BEGIN
  INSERT INTO log (ket, user, new_data, old_data)
  VALUES (CONCAT('Update data dari tabel barang, id = ', NEW.id_barang), USER(), NEW.nama_barang, old.nama_barang);
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `before_delete_brg` BEFORE DELETE ON `barang` FOR EACH ROW BEGIN
  INSERT INTO log (ket, user, old_data)
  VALUES (CONCAT('Delete data dari tabel barang id = ', OLD.id_barang), USER(), OLD.nama_barang);
END
$$
DELIMITER ;
...
CREATE TABLE `jabatan` (
  ...
  `kenaikan_gaji` text NOT NULL,
  `tgl_naik_gaji` date NOT NULL,
...
INSERT INTO `jabatan` (`id_jabatan`, `nama_jabatan`, `divisi`, `job_desc`, `status_kerja`, `gaji_pokok`, `tunjangan`, `total_gaji`, `fasilitas`, `tgl_gaji`, `kenaikan_gaji`, `tgl_naik_gaji`, `id_departemen`) VALUES
(1, 'Kepala Marketing', 'Marketing', 'Promotion, Events, Social Media', 'Full time', 5000000, 500000, 5500000, '0', '01', '0', '0000-00-00', 6),
(2, 'Kepala IT', 'IT', 'Mobile Apps, Desktop Apps, UI/UX, Web Development', 'Full time', 8000000, 0, 8000000, '0', '01', '0', '0000-00-00', 1),
(3, 'Staf IT ', 'IT', 'Frontend web application', 'Full time', 4000000, 0, 4000000, '0', '09', '0', '0000-00-00', 1),
(5, 'Staf Marketing', 'Marketing', '', 'Full time', 0, 0, 0, '', '', '', '0000-00-00', 6),
(6, 'Kepala Academic', 'Academic', '', 'Full time', 0, 0, 0, '', '', '', '0000-00-00', 3),
(7, 'Staf Finance', 'Finance', '', 'Full time', 0, 0, 0, '', '', '', '0000-00-00', 8),
(8, 'Kepala Creative Team', 'Creative Team', '', 'Full time', 0, 0, 0, '', '', '', '0000-00-00', 2),
(9, 'Staf Creative Team', 'Creative Team', '', 'Full time', 0, 0, 0, '', '', '', '0000-00-00', 2),
(10, 'Staf Academic', 'Academic', '', 'Full time', 0, 0, 0, '', '', '', '0000-00-00', 3),
(11, 'Kepala Finance', 'Finance', '', 'Full time', 0, 0, 0, '', '', '', '0000-00-00', 8),
(12, 'Staf Admin', 'Admin', '', 'Full time', 0, 0, 0, '', '', '', '0000-00-00', 4),
(13, 'Staf Data and Research', 'Development', '', 'Full time', 0, 0, 0, '', '', '', '0000-00-00', 7),
(14, 'Kepala Admin', 'Admin', '', 'Full time', 0, 0, 0, '', '', '', '0000-00-00', 4),
(15, 'Staf Legal', 'Admin', 'Mengatur hal-hal yang berkaitan dengan perjanjian dan hukum perusahaan', 'Full time', 0, 0, 0, '', '', '', '0000-00-00', 4);

--
-- Triggers `jabatan`
--
DELIMITER $$
CREATE TRIGGER `after_insert_jab` AFTER INSERT ON `jabatan` FOR EACH ROW BEGIN
  INSERT INTO log (ket, user, new_data)
  VALUES (CONCAT('Insert data ke tabel jabatan, id = ', NEW.id_jabatan), USER(), NEW.nama_jabatan);
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `after_update_jab` AFTER UPDATE ON `jabatan` FOR EACH ROW BEGIN
  INSERT INTO log (ket, user, new_data, old_data)
  VALUES (CONCAT('Update data dari tabel jabatan, id = ', NEW.id_jabatan), USER(), NEW.nama_jabatan, old.nama_jabatan);
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `before_delete_jab` BEFORE DELETE ON `jabatan` FOR EACH ROW BEGIN
  INSERT INTO log (ket, user, old_data)
  VALUES (CONCAT('Delete data dari tabel jabatan id = ', OLD.id_jabatan), USER(), OLD.nama_jabatan);
END
$$
DELIMITER ;
...
CREATE TABLE `karyawan` (
  ...
  `alamat_alternatif` varchar(255) NOT NULL,
  `rt_rw` char(8) NOT NULL,
  `kode_pos` char(5) NOT NULL,
  `provinsi` char(2) NOT NULL,
  `kabupaten` char(4) NOT NULL,
  `kecamatan` char(6) NOT NULL,
  `email_pribadi` varchar(50) NOT NULL,
  `email_kantor` longtext NOT NULL,
  `nomor_hp_pribadi` char(14) NOT NULL,
  `nomor_hp_kantor` char(14) NOT NULL,
  `status` enum('Lajang','Menikah','Cerai') NOT NULL,
  `jml_anak` char(2) NOT NULL,
  ...
  `id_jabatan` int(11) NOT NULL,
  `status_kerja` enum('Full Time','Magang','Part Time') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `karyawan` (`id`, `nip`, `nik`, `nama_depan`, `nama_tengah`, `nama_belakang`, `jenis_kelamin`, `tempat_lahir`, `tgl_lahir`, `alamat`, `alamat_alternatif`, `rt_rw`, `kode_pos`, `provinsi`, `kabupaten`, `kecamatan`, `email_pribadi`, `email_kantor`, `nomor_hp_pribadi`, `nomor_hp_kantor`, `status`, `jml_anak`, `tgl_masuk`, `pas_foto`, `foto_ktp`, `foto_kk`, `foto_npwp`, `foto_ijazah`, `id_jabatan`, `status_kerja`) VALUES
(1, '', '3578091008960003', 'Abraham', 'William', 'Pudjiono', 'Laki-Laki', 'Surabaya', '1996-08-10', 'Klampis Indah IX/1 E-65, Kel. Klampis Ngasem', '', '002/005', '60117', '35', '3578', '357802', 'abraham.will96@gmail.com', '', '085100013095', '081514072584', 'Lajang', '', '2021-01-04', '', '', '', '', '', 3, 'Full Time'),
(2, '', '3515020109860003', 'Dedi', 'Prima', 'Purnama', 'Laki-Laki', 'Sidoarjo', '1988-09-01', 'Klampisan, Kel. Wirobiting', '', '003/001', '61264', '35', '3515', '351502', 'godzhadow@gmail.com', '', '081330021002', '081513972584', 'Menikah', '1', '2020-09-07', '', '', '', '', '', 3, 'Full Time'),
(3, '', '3578075604980002', 'Delviera', 'Lukita', 'Wardani', 'Perempuan', 'Nganjuk', '1998-04-16', 'Kebangsrem 9/8 D, Kel. Genteng', '', '006/003', '60275', '35', '3578', '357807', 'delviera98@gmail.com', 'delviera@outclass.co.id', '082281551153', '081519272584', 'Lajang', '', '2020-09-08', '', '', '', '', '', 6, 'Full Time'),
(4, '', '3578260809950002', 'Deryan', 'Thimoti', 'Yudianto', 'Laki-Laki', 'Surabaya', '1995-09-08', 'Sutorejo Selatan 12/4, Kel. Dukuh Sutorejo', '', '005/008', '60113', '35', '3578', '357826', 'deryanthimoti@gmail.com', '', '082141543535', '081513772584', 'Lajang', '', '2021-01-04', '', '', '', '', '', 3, 'Full Time'),
(5, '', '5311010110970001', 'Efraim', 'Owen', 'Gunawan', 'Laki-Laki', 'Waingapu', '1997-10-01', 'Jl. Sudirman No. 12a, Kel. Kamalaputi', 'Jl. Wonorejo Permai I/7, Kel. Wonorejo, Kec. Rungkut, Kota Surabaya, Jawa Timur 60296', '007/004', '87111', '53', '5311', '531101', 'efraimowen@gmail.com', '', '082341092737', '081510972584', 'Lajang', '', '2020-09-07', '', '', '', '', '', 3, 'Full Time'),
(6, '', '3311094108980001', 'Elisha', 'Kristianti', 'Putri', 'Perempuan', 'Sukoharjo', '1998-08-01', 'Wirogunan,  Kel. Wirogunan', 'Jln. Siwalankerto Permai III/H10, Kel. Kutisari, Kec. Wonocolo, Kota Surabaya, Jawa Timur 60236', '002/003', '57166', '33', '3311', '331112', 'putri.elisha1998@gmail.com', '', '085157434486', '081519072584', 'Lajang', '', '2021-02-01', '', '', '', '', '', 5, 'Magang'),
(7, '', '5371023103950004', 'Frido', 'Marguido', 'Moa Belang', 'Laki-Laki', 'Kupang', '1995-03-31', 'Kel. Penfui', 'Puncak Kertajaya, Jln. Kertajaya Indah Regency, Kel. Keputih, Kec. Sukolilo, Kota Surabaya, Jawa Timur 60111', '024/011', '85148', '53', '5371', '537102', 'ocfridho@gmail.com', 'accounting@outclass.co.id', '082140675596', '081517572584', 'Lajang', '', '2021-01-18', '', '', '', '', '', 7, 'Full Time'),
(8, '', '3577026410980002', 'Gresiana', 'Gede', 'Wirawati', 'Perempuan', 'Madiun', '1998-10-24', 'Patimura 27B, Kel. Bangunsari', 'Apartemen Bale Hinggil, Jl. Medokan Semampir Indah No. 63, Kel. Medokan Semampir, Kec. Sukolilo, Kota Surabaya, Jawa Timur 60119', '008/001', '63153', '35', '3519', '351911', 'gresiana.gede@gmail.com', 'gresia@outclass.co.id', '081333775098', '081517172584', 'Lajang', '', '2020-09-23', '', '', '', '', '', 1, 'Full Time'),
(9, '', '3578031403970003', 'Kevin', 'Dewangga', 'Sugiharto', 'Laki-Laki', 'Surabaya', '1997-03-14', 'Wiguna Timur Regency IV/16,  Kel. Gunung Anyar', '', '003/009', '60294', '35', '3578', '357825', 'kdewangga1997@gmail.com', 'outclass.creative34@gmail.com', '087855447025', '081519872584', 'Lajang', '', '2020-11-20', '', '', '', '', '', 9, 'Full Time'),
(10, '', '6472031711940002', 'Michael', '', 'Santoso', 'Laki-Laki', 'Lumajang', '1994-11-17', 'Jl. Aw. Syarani, Kel. Gunung Kelua', 'Jl. Wonorejo Permai I/7, Kel. Wonorejo, Kec. Rungkut, Kota Surabaya, Jawa Timur 60297', '011/000', '75123', '64', '6472', '647203', 'santosomichael94@gmail.com', 'outclass.development@gmail.com, outclassindo@gmail.com', '08113421137', '081517872584', 'Lajang', '', '2020-09-01', '', '', '', '', '', 2, 'Full Time'),
(11, '', '6472052808980009', 'Nico', '', 'Gufron', 'Laki-Laki', 'Samarinda', '1998-08-28', 'Jl. A Yani No. 17, Kel. Sungai Pinang Dalam', 'Jln. Siwalankerto Permai 1/A13, Kel. Kutisari, Kec. Wonocolo, Kota Surabaya, Jawa Timur 60236', '009/000', '75117', '64', '6472', '647208', 'nicogufron@gmail.com', '', '085257375866', '081511072584', 'Lajang', '', '2020-11-09', '', '', '', '', '', 3, 'Full Time'),
(12, '', '3515171301010003', 'Oliver', 'William', 'Arifin', 'Laki-Laki', 'Surabaya', '2001-01-13', 'Sedati Permai BB 42, Kel. Pabean', '', '036/013', '61253', '35', '3515', '351517', 'williamoliver252@gmail.com', '', '081390204985', '08151672584', 'Lajang', '', '2020-12-11', '', '', '', '', '', 10, 'Full Time'),
(13, '', '3528040703810001', 'R. Ahmed', 'Rizal', 'Maulana', 'Laki-Laki', 'Pamekasan', '1981-03-07', 'Jl. Stadion 7/9, Kel. Barulambat Kota', '', '006/005', '69317', '35', '3528', '352804', 'zaals.maulana@gmail.com', 'outclass.creative31@gmail.com', '085330165157', '081514272584', 'Lajang', '', '2020-09-13', '', '', '', '', '', 9, 'Full Time'),
(14, '', '3509211112940004', 'Richard', 'Putra', 'Sugijanto', 'Laki-Laki', 'Lumajang', '1994-12-11', 'Jl. Letjend. Suprapto 89, Ling. Sbr. Dandang, Kel. Kebonsari', 'Kertajaya Indah Regency, Kel. Keputih, Kec. Sukolilo, Kota Surabaya, Jawa Timur 60111', '003/004', '68122', '35', '3509', '350921', 'richardputras1994@gmail.com', 'support@outclass.co.id', '085101768753', '081517672584', 'Lajang', '', '2020-11-09', '', '', '', '', '', 12, 'Full Time'),
(15, '', '3578026109980004', 'Seruni', 'Desfa', 'Maharani', 'Perempuan', 'Jakarta', '1998-09-21', 'Bendul Merisi Permai P-9, Kel. Bendul Merisi', '', '007/009', '60239', '35', '3578', '357802', 'serunidesfaa@gmail.com', '', '081244285636', '08151872584', 'Lajang', '', '2020-11-30', '', '', '', '', '', 5, 'Full Time'),
(16, '', '3578031011970003', 'Sie', 'Ivan', 'Hinman', 'Laki-Laki', 'Ambon', '1997-11-10', 'Wonorejo Permai Sel. 6/CC-448, Kel. Wonorejo', '', '003/006', '60296', '35', '3578', '357803', 'sieivan12@gmail.com', '', '085157626988', '081586372584', 'Lajang', '', '2021-01-04', '', '', '', '', '', 3, 'Full Time'),
(17, '', '5371041309980002', 'Timotius', 'Randia', 'Barus', 'Laki-Laki', 'Kupang', '1998-09-13', 'Perumahan Dosen Poltekes, Kel. Liliba', 'Jln. Siwalankerto Permai 1/C4, Kel. Kutisari, Kec. Wonocolo, Kota Surabaya, Jawa Timur 60236', '003/006', '85111', '53', '5371', '537104', 'timothybarus13@gmail.com', '', '081339645541', '081514672584', 'Lajang', '', '2020-11-17', '', '', '', '', '', 3, 'Full Time'),
(18, '', '3578071204810003', 'Vicky', '', 'Ponto', 'Laki-Laki', 'Surabaya', '1981-04-12', 'Sutorejo Tengah 2/2, Kel.Dukuh Sutorejo', '', '012/008', '60113', '35', '3578', '357826', 'vicky.ponto81@gmail.com', 'outclass.creative21@gmail.com', '08172300123', '081513172584', 'Lajang', '', '2020-09-13', '', '', '', '', '', 9, 'Full Time'),
(19, '', '3578242910870001', 'Wikantono', '', 'Danakusuma', 'Laki-Laki', 'Surabaya', '1987-10-29', 'Kutisari Indah Utara IV/35, Kel. Kutisari', '', '003/008', '60291', '35', '3578', '357824', 'kanzhirou@gmail.com', 'outclass.creative20@gmail.com', '08113392726', '081514472584', 'Lajang', '', '2020-09-07', '', '', '', '', '', 8, 'Full Time'),
(20, '', '3578090711960002', 'William', '', 'Christian', 'Laki-Laki', 'Surabaya', '1996-11-07', 'Manyar Jaya 4/C-17, Kel. Menur Pumpungan', '', '005/008', '60118', '35', '3578', '357809', 'wecehgundam@gmail.com', 'outclass.creative33@gmail.com', '081235147982', '081511672584', 'Lajang', '', '2020-10-01', '', '', '', '', '', 9, 'Full Time'),
(21, '', '3578250801990001', 'Ariel', 'Moses', 'Kurniawan', 'Laki-Laki', 'Surabaya', '1999-01-08', 'Rungkut Mapan Barat 3/AB 16', 'Kutisari Selatan gang 13, Kav. 7, Surabaya', '003/008', '60293', '35', '3578', '357825', 'arielmoseskurniawan@gmail.com', '', '089602085548', '081519472584', 'Lajang', '', '2021-02-11', '', '', '', '', '', 10, 'Magang'),
(22, '', '3578061906960005', 'Junifar', 'Rizky', 'Dharmawan', 'Laki-Laki', 'Surabaya', '1996-06-19', 'Petemon Barat 192-A, Kel. Petemon', '', '006/014', '60252', '35', '3578', '357806', 'junifarrizkydharmawan@gmail.com', '', '083831111924', '081517072584', 'Lajang', '', '2021-02-26', '', '', '', '', '', 12, 'Full Time'),
(23, '', '3578222612980002', 'Trechsna', 'Ali', 'Ramadhani', 'Laki-Laki', 'Surabaya', '1998-12-26', 'Ketintang Barat Indah 26, Kel. Ketintang', '', '008/006', '60231', '35', '3578', '357822', 'trechsna.dhani@gmail.com', '', '081235693784', '', 'Lajang', '', '2021-03-16', '', '', '', '', '', 15, 'Full Time');
...
CREATE TABLE `kelas` (
  ...
  `jam` time NOT NULL,
  `jumlah_murid` char(3) NOT NULL,
  `judul` longtext NOT NULL,
  `topik` longtext NOT NULL,
  `harga` enum('bayar','gratis') NOT NULL
...
CREATE TABLE `log` (
  ...
  `old_data` char(200) NOT NULL,
  `new_data` char(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `log` (`id_log`, `ket`, `waktu`, `user`, `old_data`, `new_data`) VALUES
(1, 'Update data dari tabel barang, id = 4', '2021-02-04 08:57:05', 'root@localhost', 'Personal Computer (PC)', 'Personal Computer (PC)'),
(2, 'Update data dari tabel barang, id = 4', '2021-02-04 09:29:29', 'root@localhost', 'Personal Computer (PC)', 'Personal Computer (PC)'),
(3, 'Update data dari tabel barang, id = 4', '2021-02-04 09:29:43', 'root@localhost', 'Personal Computer (PC)', 'Personal Computer (PC)'),
(4, 'Update data dari tabel barang, id = 4', '2021-02-08 04:47:11', 'root@localhost', 'Personal Computer (PC)', 'Personal Computer (PC)'),
(5, 'Update data dari tabel barang, id = 4', '2021-02-08 04:47:29', 'root@localhost', 'Personal Computer (PC)', 'Personal Computer (PC)'),
(6, 'Insert data ke tabel jabatan, id = 5', '2021-02-09 06:49:35', 'momentum_richard@localhost', '', 'Kepala Academic'),
(7, 'Insert data ke tabel jabatan, id = 6', '2021-02-09 06:50:14', 'momentum_richard@localhost', '', 'Staf Finance'),
(8, 'Insert data ke tabel jabatan, id = 7', '2021-02-09 06:50:50', 'momentum_richard@localhost', '', 'Kepala Finance'),
(9, 'Insert data ke tabel jabatan, id = 8', '2021-02-09 06:51:14', 'momentum_richard@localhost', '', 'Staf Marketing'),
(10, 'Insert data ke tabel jabatan, id = 9', '2021-02-09 06:52:05', 'momentum_richard@localhost', '', 'Staf Academic'),
(11, 'Delete data dari tabel barang id = 4', '2021-02-09 07:16:50', 'momentum_richard@localhost', 'Personal Computer (PC)', ''),
(12, 'Delete data dari tabel jabatan id = 1', '2021-02-13 05:31:15', 'momentum@localhost', 'Kepala Marketing', ''),
(13, 'Delete data dari tabel jabatan id = 2', '2021-02-13 05:31:15', 'momentum@localhost', 'Kepala IT', ''),
(14, 'Delete data dari tabel jabatan id = 3', '2021-02-13 05:31:15', 'momentum@localhost', 'Staf IT', ''),
(15, 'Delete data dari tabel jabatan id = 5', '2021-02-13 05:31:15', 'momentum@localhost', 'Kepala Academic', ''),
(16, 'Delete data dari tabel jabatan id = 6', '2021-02-13 05:31:15', 'momentum@localhost', 'Staf Finance', ''),
(17, 'Delete data dari tabel jabatan id = 7', '2021-02-13 05:31:15', 'momentum@localhost', 'Kepala Finance', ''),
(18, 'Delete data dari tabel jabatan id = 8', '2021-02-13 05:31:15', 'momentum@localhost', 'Staf Marketing', ''),
(19, 'Delete data dari tabel jabatan id = 9', '2021-02-13 05:31:15', 'momentum@localhost', 'Staf Academic', ''),
(20, 'Insert data ke tabel jabatan, id = 1', '2021-02-13 05:40:54', 'momentum@localhost', '', 'Kepala Marketing'),
(21, 'Insert data ke tabel jabatan, id = 2', '2021-02-13 05:40:54', 'momentum@localhost', '', 'Kepala IT'),
(22, 'Insert data ke tabel jabatan, id = 3', '2021-02-13 05:40:54', 'momentum@localhost', '', 'Staf IT'),
(23, 'Insert data ke tabel jabatan, id = 5', '2021-02-13 05:40:54', 'momentum@localhost', '', 'Staf Marketing'),
(24, 'Insert data ke tabel jabatan, id = 6', '2021-02-13 05:40:54', 'momentum@localhost', '', 'Kepala Academic'),
(25, 'Insert data ke tabel jabatan, id = 7', '2021-02-13 05:40:54', 'momentum@localhost', '', 'Staf Finance'),
(26, 'Insert data ke tabel jabatan, id = 8', '2021-02-13 05:40:54', 'momentum@localhost', '', 'Kepala Creative Team'),
(27, 'Insert data ke tabel jabatan, id = 9', '2021-02-13 05:40:54', 'momentum@localhost', '', 'Staf Creative Team'),
(28, 'Insert data ke tabel jabatan, id = 10', '2021-02-13 05:40:54', 'momentum@localhost', '', 'Staf Academic'),
(29, 'Insert data ke tabel jabatan, id = 11', '2021-02-13 05:40:54', 'momentum@localhost', '', 'Kepala Finance'),
(30, 'Insert data ke tabel jabatan, id = 12', '2021-02-13 05:40:54', 'momentum@localhost', '', 'Staf Admin'),
(31, 'Update data dari tabel supplier, id = 1', '2021-02-16 04:30:46', 'momentum_richard@localhost', 'CV Maju Terus', 'Focus'),
(32, 'Update data dari tabel supplier, id = 1', '2021-02-16 04:31:08', 'momentum_richard@localhost', 'Focus', 'Focus'),
(33, 'Update data dari tabel supplier, id = 1', '2021-02-16 04:31:41', 'momentum_richard@localhost', 'Focus', 'Focus'),
(34, 'Update data dari tabel supplier, id = 1', '2021-02-16 04:33:56', 'momentum_richard@localhost', 'Focus', 'Focus'),
(35, 'Insert data ke tabel barang, id = 6', '2021-02-16 04:35:33', 'momentum_richard@localhost', '', 'Personal Computer (PC)'),
(36, 'Insert data ke tabel barang, id = 7', '2021-02-16 04:40:12', 'momentum_richard@localhost', '', 'LED Lamp'),
(37, 'Update data dari tabel barang, id = 7', '2021-02-16 04:41:55', 'momentum_richard@localhost', 'LED Lamp', 'LED Lamp'),
(38, 'Insert data ke tabel barang, id = 8', '2021-02-16 04:45:18', 'momentum_richard@localhost', '', 'Godox SL-60W Video LED'),
(39, 'Insert data ke tabel barang, id = 9', '2021-02-16 04:46:19', 'momentum_richard@localhost', '', 'Reflektor'),
(40, 'Insert data ke tabel barang, id = 10', '2021-02-16 04:52:33', 'momentum_richard@localhost', '', 'Kain Green Screen'),
(41, 'Insert data ke tabel barang, id = 11', '2021-02-16 04:54:08', 'momentum_richard@localhost', '', 'Lampu Studio Softbox'),
(42, 'Insert data ke tabel barang, id = 12', '2021-02-16 05:28:00', 'momentum_richard@localhost', '', 'Teleprompter'),
(43, 'Update data dari tabel barang, id = 10', '2021-02-16 05:28:39', 'momentum_richard@localhost', 'Kain Green Screen', 'Kain Green Screen'),
(44, 'Insert data ke tabel barang, id = 13', '2021-02-16 05:30:25', 'momentum_richard@localhost', '', 'Tether Tools Case Relay Camera'),
(45, 'Update data dari tabel barang, id = 9', '2021-02-16 05:32:03', 'momentum_richard@localhost', 'Reflektor', 'Reflektor'),
(46, 'Update data dari tabel barang, id = 11', '2021-02-16 05:32:29', 'momentum_richard@localhost', 'Lampu Studio Softbox', 'Lampu Studio Softbox'),
(47, 'Update data dari tabel barang, id = 10', '2021-02-16 05:32:57', 'momentum_richard@localhost', 'Kain Green Screen', 'Kain Green Screen'),
(48, 'Update data dari tabel barang, id = 13', '2021-02-16 05:34:39', 'momentum_richard@localhost', 'Tether Tools Case Relay Camera', 'Tether Tools Case Relay Camera'),
(49, 'Insert data ke tabel barang, id = 14', '2021-02-16 05:36:18', 'momentum_richard@localhost', '', 'Light Stand'),
(50, 'Update data dari tabel barang, id = 12', '2021-02-16 05:37:26', 'momentum_richard@localhost', 'Teleprompter', 'Teleprompter'),
(51, 'Insert data ke tabel barang, id = 15', '2021-02-16 05:39:26', 'momentum_richard@localhost', '', 'Klip Jepit Backdrop'),
(52, 'Update data dari tabel barang, id = 14', '2021-02-16 05:40:10', 'momentum_richard@localhost', 'Light Stand', 'Light Stand'),
(53, 'Update data dari tabel barang, id = 8', '2021-02-16 05:44:51', 'momentum_richard@localhost', 'Godox SL-60W Video LED', 'Video LED'),
(54, 'Insert data ke tabel barang, id = 16', '2021-02-16 07:18:05', 'momentum_richard@localhost', '', 'Personal Computer (PC)'),
(55, 'Insert data ke tabel barang, id = 17', '2021-02-16 07:21:05', 'momentum_richard@localhost', '', 'USB Wifi TP-Link'),
(56, 'Insert data ke tabel barang, id = 18', '2021-02-16 07:23:12', 'momentum_richard@localhost', '', 'Hydro Cooling'),
(57, 'Insert data ke tabel barang, id = 19', '2021-02-16 07:24:25', 'momentum_richard@localhost', '', 'Stavolt'),
(58, 'Insert data ke tabel barang, id = 20', '2021-02-16 07:29:45', 'momentum_richard@localhost', '', 'Busa Peredam'),
(59, 'Insert data ke tabel barang, id = 21', '2021-02-16 07:31:24', 'momentum_richard@localhost', '', 'Mic Studio'),
(60, 'Insert data ke tabel barang, id = 22', '2021-02-16 07:33:06', 'momentum_richard@localhost', '', 'iPhone SE'),
(61, 'Insert data ke tabel barang, id = 23', '2021-02-16 07:35:40', 'momentum_richard@localhost', '', 'Xiaomi Redmi Note 9'),
(62, 'Update data dari tabel barang, id = 23', '2021-02-16 07:36:34', 'momentum_richard@localhost', 'Xiaomi Redmi Note 9', 'Xiaomi Redmi Note 9'),
(63, 'Update data dari tabel barang, id = 9', '2021-02-16 07:37:44', 'momentum_richard@localhost', 'Reflektor', 'Reflektor'),
(64, 'Insert data ke tabel barang, id = 24', '2021-02-16 07:39:13', 'momentum_richard@localhost', '', 'Windows 10 ORI'),
(65, 'Insert data ke tabel barang, id = 25', '2021-02-16 07:40:21', 'momentum_richard@localhost', '', 'HDMI Capture Card'),
(66, 'Insert data ke tabel barang, id = 26', '2021-02-16 07:41:36', 'momentum_richard@localhost', '', 'Kain Green Screen'),
(67, 'Insert data ke tabel barang, id = 27', '2021-02-16 07:43:00', 'momentum_richard@localhost', '', 'Windows ORI'),
(68, 'Insert data ke tabel barang, id = 28', '2021-02-16 07:43:46', 'momentum_richard@localhost', '', 'USB 4 Port'),
(69, 'Insert data ke tabel barang, id = 29', '2021-02-16 07:44:38', 'momentum_richard@localhost', '', 'Meja Komputer'),
(70, 'Insert data ke tabel barang, id = 30', '2021-02-16 07:46:20', 'momentum_richard@localhost', '', 'Laptop'),
(71, 'Update data dari tabel barang, id = 5', '2021-02-16 07:47:04', 'momentum@localhost', 'Laptop', 'Laptop'),
(72, 'Update data dari tabel user, id = 1', '2021-02-16 09:03:39', 'momentum_richard@localhost', 'Rich', 'Richard'),
(73, 'Update data dari tabel barang, id = 27', '2021-02-16 09:35:16', 'momentum_richard@localhost', 'Windows ORI', 'Windows 10 ORI'),
(74, 'Insert data ke tabel barang, id = 31', '2021-02-16 09:37:11', 'momentum_richard@localhost', '', 'Webcam'),
(75, 'Insert data ke tabel barang, id = 32', '2021-02-16 09:38:23', 'momentum_richard@localhost', '', 'Kabel Audio'),
(76, 'Insert data ke tabel barang, id = 33', '2021-02-17 06:49:58', 'momentum_richard@localhost', '', 'Mini Keyboard'),
(77, 'Insert data ke tabel barang, id = 34', '2021-02-17 06:52:49', 'momentum_richard@localhost', '', 'Kabel Adapter HDMI to VGA'),
(78, 'Insert data ke tabel barang, id = 35', '2021-02-17 07:35:46', 'momentum_richard@localhost', '', 'Velcro Kretekan'),
(79, 'Update data dari tabel barang, id = 13', '2021-02-17 08:07:08', 'momentum_richard@localhost', 'Tether Tools Case Relay Camera', 'Tether Tools/Case Relay Camera'),
(80, 'Update data dari tabel barang, id = 11', '2021-02-17 08:08:21', 'momentum_richard@localhost', 'Lampu Studio Softbox', 'Lampu Studio Softbox'),
(81, 'Insert data ke tabel supplier, id = 2', '2021-02-17 08:17:30', 'momentum_richard@localhost', '', 'Toko Hartono'),
(82, 'Update data dari tabel barang, id = 35', '2021-02-19 06:29:07', 'momentum@localhost', 'Velcro Kretekan', 'Velcro Kretekan'),
(83, 'Insert data ke tabel supplier, id = 3', '2021-02-19 06:35:44', 'momentum_richard@localhost', '', 'Prologic Computer'),
(84, 'Update data dari tabel barang, id = 28', '2021-02-19 06:36:53', 'momentum@localhost', 'USB 4 Port', 'USB Hub 4 Port 2.0'),
(85, 'Insert data ke tabel supplier, id = 4', '2021-02-19 06:39:16', 'momentum_richard@localhost', '', 'Beverly Hills Cellular'),
(86, 'Update data dari tabel barang, id = 22', '2021-02-19 06:41:06', 'momentum@localhost', 'iPhone SE', 'iPhone SE'),
(87, 'Update data dari tabel barang, id = 23', '2021-02-19 06:41:06', 'momentum@localhost', 'Xiaomi Redmi Note 9', 'Xiaomi Redmi Note 9'),
(88, 'Update data dari tabel barang, id = 36', '2021-02-20 03:15:49', 'momentum@localhost', 'Kabel Audio', 'Kabel Audio'),
(89, 'Update data dari tabel barang, id = 37', '2021-02-20 03:15:49', 'momentum@localhost', 'Mini Keyboard', 'Mini Keyboard'),
(90, 'Update data dari tabel barang, id = 38', '2021-02-20 03:15:49', 'momentum@localhost', 'Kabel Adapter HDMI to VGA', 'Kabel Adapter HDMI to VGA'),
(91, 'Update data dari tabel barang, id = 40', '2021-02-20 03:18:43', 'momentum@localhost', 'Busa Peredam', 'Busa Peredam'),
(92, 'Update data dari tabel barang, id = 41', '2021-02-20 03:18:43', 'momentum@localhost', 'Mic Studio', 'Mic Studio'),
(93, 'Update data dari tabel barang, id = 42', '2021-02-20 03:18:43', 'momentum@localhost', 'iPhone SE', 'iPhone SE'),
(94, 'Update data dari tabel barang, id = 43', '2021-02-20 03:18:43', 'momentum@localhost', 'Xiaomi Redmi Note 9', 'Xiaomi Redmi Note 9'),
(95, 'Update data dari tabel barang, id = 44', '2021-02-20 03:18:43', 'momentum@localhost', 'Windows 10 ORI', 'Windows 10 ORI'),
(96, 'Update data dari tabel barang, id = 45', '2021-02-20 03:18:43', 'momentum@localhost', 'HDMI Capture Card', 'HDMI Capture Card'),
(97, 'Update data dari tabel barang, id = 46', '2021-02-20 03:18:43', 'momentum@localhost', 'Kain Green Screen', 'Kain Green Screen'),
(98, 'Update data dari tabel barang, id = 47', '2021-02-20 03:18:43', 'momentum@localhost', 'Windows 10 ORI', 'Windows 10 ORI'),
(99, 'Update data dari tabel barang, id = 48', '2021-02-20 03:18:43', 'momentum@localhost', 'USB Hub 4 Port 2.0', 'USB Hub 4 Port 2.0'),
(100, 'Update data dari tabel barang, id = 49', '2021-02-20 03:18:43', 'momentum@localhost', 'Meja Komputer', 'Meja Komputer'),
(101, 'Update data dari tabel barang, id = 20', '2021-02-20 03:19:20', 'momentum@localhost', 'Kabel Audio', 'Kabel Audio'),
(102, 'Update data dari tabel barang, id = 21', '2021-02-20 03:20:10', 'momentum@localhost', 'Busa Peredam', 'Busa Peredam'),
(103, 'Update data dari tabel barang, id = 22', '2021-02-20 03:20:10', 'momentum@localhost', 'Mic Studio', 'Mic Studio'),
(104, 'Update data dari tabel barang, id = 23', '2021-02-20 03:20:10', 'momentum@localhost', 'iPhone SE', 'iPhone SE'),
(105, 'Update data dari tabel barang, id = 24', '2021-02-20 03:20:10', 'momentum@localhost', 'Xiaomi Redmi Note 9', 'Xiaomi Redmi Note 9'),
(106, 'Update data dari tabel barang, id = 25', '2021-02-20 03:20:10', 'momentum@localhost', 'Windows 10 ORI', 'Windows 10 ORI'),
(107, 'Update data dari tabel barang, id = 26', '2021-02-20 03:22:30', 'momentum@localhost', 'HDMI Capture Card', 'HDMI Capture Card'),
(108, 'Update data dari tabel barang, id = 27', '2021-02-20 03:22:30', 'momentum@localhost', 'Kain Green Screen', 'Kain Green Screen'),
(109, 'Update data dari tabel barang, id = 28', '2021-02-20 03:22:30', 'momentum@localhost', 'Windows 10 ORI', 'Windows 10 ORI'),
(110, 'Update data dari tabel barang, id = 29', '2021-02-20 03:22:30', 'momentum@localhost', 'USB Hub 4 Port 2.0', 'USB Hub 4 Port 2.0'),
(111, 'Update data dari tabel barang, id = 30', '2021-02-20 03:22:30', 'momentum@localhost', 'Meja Komputer', 'Meja Komputer'),
(112, 'Update data dari tabel barang, id = 32', '2021-02-20 03:24:20', 'momentum@localhost', 'Velcro Kretekan', 'Velcro Kretekan'),
(113, 'Update data dari tabel barang, id = 33', '2021-02-20 03:24:20', 'momentum@localhost', 'Mini Keyboard', 'Mini Keyboard'),
(114, 'Update data dari tabel barang, id = 34', '2021-02-20 03:24:20', 'momentum@localhost', 'Kabel Adapter HDMI to VGA', 'Kabel Adapter HDMI to VGA'),
(115, 'Update data dari tabel barang, id = 30', '2021-02-20 03:25:43', 'momentum@localhost', 'Meja Komputer', 'Meja Komputer'),
(116, 'Update data dari tabel barang, id = 25', '2021-02-20 03:27:57', 'momentum@localhost', 'Windows 10 ORI', 'Windows 10 ORI'),
(117, 'Update data dari tabel barang, id = 9', '2021-02-20 03:32:16', 'momentum@localhost', 'Reflektor', 'Reflektor'),
(118, 'Update data dari tabel barang, id = 9', '2021-02-20 03:32:51', 'momentum@localhost', 'Reflektor', 'Reflektor'),
(119, 'Update data dari tabel barang, id = 27', '2021-02-20 03:33:36', 'momentum@localhost', 'Kain Green Screen', 'Kain Green Screen'),
(120, 'Update data dari tabel barang, id = 8', '2021-02-20 03:34:11', 'momentum@localhost', 'Video LED', 'Video LED'),
(121, 'Update data dari tabel barang, id = 5', '2021-02-22 06:36:24', 'momentum_richard@localhost', 'Laptop', 'Laptop'),
(122, 'Update data dari tabel barang, id = 6', '2021-02-22 06:39:10', 'momentum_richard@localhost', 'Personal Computer (PC)', 'Personal Computer (PC)'),
(123, 'Insert data ke tabel barang, id = 35', '2021-02-22 06:40:45', 'momentum_richard@localhost', '', 'USB Wifi TP-Link'),
(124, 'Insert data ke tabel barang, id = 36', '2021-02-22 06:41:34', 'momentum_richard@localhost', '', 'Hydro Cooling'),
(125, 'Insert data ke tabel barang, id = 37', '2021-02-22 06:42:36', 'momentum_richard@localhost', '', 'Stavolt'),
(126, 'Insert data ke tabel barang, id = 38', '2021-02-22 06:49:09', 'momentum_richard@localhost', '', 'Kain Hitam'),
(127, 'Update data dari tabel barang, id = 7', '2021-02-22 06:50:39', 'momentum_richard@localhost', 'LED Lamp', 'LED Lamp'),
(128, 'Update data dari tabel barang, id = 22', '2021-02-22 06:55:51', 'momentum_richard@localhost', 'Mic Studio', 'Mic Studio'),
(129, 'Update data dari tabel barang, id = 22', '2021-02-22 06:56:44', 'momentum_richard@localhost', 'Mic Studio', 'Mic Studio'),
(130, 'Update data dari tabel barang, id = 13', '2021-02-22 07:03:25', 'momentum_richard@localhost', 'Tether Tools/Case Relay Camera', 'Tether Tools/Case Relay Camera'),
(131, 'Update data dari tabel barang, id = 23', '2021-02-22 07:23:13', 'momentum_richard@localhost', 'iPhone SE', 'iPhone SE'),
(132, 'Insert data ke tabel barang, id = 39', '2021-02-22 09:38:13', 'momentum_richard@localhost', '', 'iPad 3'),
(133, 'Update data dari tabel barang, id = 39', '2021-02-22 09:38:56', 'momentum_richard@localhost', 'iPad 3', 'iPad 3'),
(134, 'Insert data ke tabel barang, id = 40', '2021-02-22 09:40:15', 'momentum_richard@localhost', '', 'iPad 3'),
(135, 'Update data dari tabel barang, id = 27', '2021-02-22 09:45:44', 'momentum_richard@localhost', 'Kain Green Screen', 'Kain Green Screen'),
(136, 'Insert data ke tabel barang, id = 41', '2021-02-22 09:50:46', 'momentum_richard@localhost', '', 'Bracket TV'),
(137, 'Insert data ke tabel barang, id = 42', '2021-02-22 09:52:11', 'momentum_richard@localhost', '', 'Bracket TV'),
(138, 'Insert data ke tabel barang, id = 43', '2021-02-22 09:58:44', 'momentum_richard@localhost', '', 'Swivel with Wall Plate'),
(139, 'Insert data ke tabel barang, id = 44', '2021-02-22 10:02:19', 'momentum_richard@localhost', '', 'Kursi'),
(140, 'Insert data ke tabel barang, id = 45', '2021-02-22 10:11:31', 'momentum_richard@localhost', '', 'Macbook Pro 2011'),
(141, 'Update data dari tabel barang, id = 7', '2021-02-23 04:22:17', 'momentum_richard@localhost', 'LED Lamp', 'Lampu LED 14W'),
(142, 'Insert data ke tabel barang, id = 46', '2021-02-23 04:25:00', 'momentum_richard@localhost', '', 'Portable DVD-RW'),
(143, 'Insert data ke tabel barang, id = 47', '2021-02-23 04:26:58', 'momentum_richard@localhost', '', 'Kabel HDMI'),
(144, 'Update data dari tabel barang, id = 46', '2021-02-23 04:27:30', 'momentum_richard@localhost', 'Portable DVD-RW', 'Portable DVD Writer'),
(145, 'Insert data ke tabel barang, id = 48', '2021-02-23 04:28:34', 'momentum_richard@localhost', '', 'Kabel Power CPU'),
(146, 'Insert data ke tabel barang, id = 49', '2021-02-23 04:41:11', 'momentum_richard@localhost', '', 'Kabel HDMI'),
(147, 'Delete data dari tabel barang id = 9', '2021-02-23 05:24:57', 'momentum_richard@localhost', 'Reflektor', ''),
(148, 'Update data dari tabel barang, id = 21', '2021-02-23 05:37:14', 'momentum_richard@localhost', 'Busa Peredam', 'Busa Peredam'),
(149, 'Insert data ke tabel barang, id = 50', '2021-02-23 05:55:57', 'momentum_richard@localhost', '', 'Charger iPhone SE'),
(150, 'Update data dari tabel barang, id = 30', '2021-02-23 06:12:46', 'momentum_richard@localhost', 'Meja Komputer', 'Meja'),
(151, 'Insert data ke tabel barang, id = 51', '2021-02-23 06:15:15', 'momentum_richard@localhost', '', 'Android TV'),
(152, 'Update data dari tabel barang, id = 51', '2021-02-23 06:16:25', 'momentum_richard@localhost', 'Android TV', 'Android TV'),
(153, 'Insert data ke tabel supplier, id = 5', '2021-02-23 06:19:36', 'momentum_richard@localhost', '', 'Surya Agung'),
(154, 'Insert data ke tabel barang, id = 52', '2021-02-23 06:20:59', 'momentum_richard@localhost', '', 'Air Conditioner'),
(155, 'Insert data ke tabel barang, id = 53', '2021-02-23 07:37:13', 'momentum_richard@localhost', '', 'Tripod'),
(156, 'Update data dari tabel barang, id = 30', '2021-02-23 08:05:58', 'momentum@localhost', 'Meja', 'Meja'),
(157, 'Update data dari tabel barang, id = 5', '2021-02-23 08:17:40', 'momentum_richard@localhost', 'Laptop', 'Laptop'),
(158, 'Update data dari tabel user, id = 2', '2021-02-24 04:46:51', 'momentum_richard@localhost', 'Rick', 'Frido'),
(159, 'Update data dari tabel user, id = 2', '2021-02-24 04:47:38', 'momentum@localhost', 'Frido', 'Frido'),
(160, 'Update data dari tabel barang, id = 30', '2021-02-24 05:15:41', 'momentum_richard@localhost', 'Meja', 'Meja Kerja'),
(161, 'Update data dari tabel barang, id = 44', '2021-02-24 05:23:49', 'momentum_richard@localhost', 'Kursi', 'Kursi Kerja'),
(162, 'Insert data ke tabel user, id = 5', '2021-02-24 06:54:13', 'momentum_richard@localhost', '', 'Wikantono'),
(163, 'Update data dari tabel user, id = 3', '2021-02-24 07:00:52', 'momentum@localhost', 'Wikantono', 'Wikantono'),
(164, 'Update data dari tabel user, id = 1', '2021-02-24 07:01:48', 'momentum@localhost', 'Richard', 'Richard'),
(165, 'Update data dari tabel barang, id = 35', '2021-02-24 07:25:42', 'momentum_richard@localhost', 'USB Wifi TP-Link', 'USB Wifi TP-Link'),
(166, 'Update data dari tabel barang, id = 35', '2021-02-24 07:27:44', 'momentum@localhost', 'USB Wifi TP-Link', 'USB Wifi TP-Link'),
(167, 'Update data dari tabel barang, id = 36', '2021-02-24 07:27:44', 'momentum@localhost', 'Hydro Cooling', 'Hydro Cooling'),
(168, 'Update data dari tabel barang, id = 37', '2021-02-24 07:27:44', 'momentum@localhost', 'Stavolt', 'Stavolt'),
(169, 'Update data dari tabel barang, id = 44', '2021-02-24 07:34:07', 'momentum@localhost', 'Kursi Kerja', 'Kursi Kerja'),
(170, 'Update data dari tabel barang, id = 30', '2021-02-24 07:43:11', 'momentum@localhost', 'Meja Kerja', 'Meja Kerja'),
(171, 'Insert data ke tabel supplier, id = 6', '2021-02-24 07:44:24', 'momentum_richard@localhost', '', 'Cahaya Technic'),
(172, 'Insert data ke tabel supplier, id = 7', '2021-02-24 07:47:01', 'momentum_richard@localhost', '', 'MLMFOTO'),
(173, 'Insert data ke tabel supplier, id = 8', '2021-02-24 07:54:07', 'momentum_richard@localhost', '', 'PlayHardID'),
(174, 'Insert data ke tabel supplier, id = 9', '2021-02-24 07:55:48', 'momentum_richard@localhost', '', 'Astra Foto'),
(175, 'Update data dari tabel supplier, id = 7', '2021-02-24 07:56:31', 'momentum_richard@localhost', 'MLMFOTO', 'MLMFOTO'),
(176, 'Insert data ke tabel supplier, id = 10', '2021-02-24 07:57:30', 'momentum_richard@localhost', '', 'arTechno Digital'),
(177, 'Insert data ke tabel supplier, id = 11', '2021-02-24 07:58:28', 'momentum_richard@localhost', '', 'Plaza Kamera'),
(178, 'Update data dari tabel supplier, id = 8', '2021-02-24 07:58:56', 'momentum_richard@localhost', 'PlayHardID', 'PlayHardID'),
(179, 'Update data dari tabel supplier, id = 7', '2021-02-24 08:00:21', 'momentum_richard@localhost', 'MLMFOTO', 'MLMFOTO'),
(180, 'Update data dari tabel supplier, id = 6', '2021-02-24 08:02:42', 'momentum_richard@localhost', 'Cahaya Technic', 'Cahaya Technic'),
(181, 'Insert data ke tabel supplier, id = 12', '2021-02-24 08:14:30', 'momentum_richard@localhost', '', 'Pixmix'),
(182, 'Insert data ke tabel supplier, id = 13', '2021-02-24 08:15:44', 'momentum_richard@localhost', '', 'mitrakamera'),
(183, 'Insert data ke tabel supplier, id = 14', '2021-02-24 08:35:20', 'momentum_richard@localhost', '', 'tech_market'),
(184, 'Update data dari tabel supplier, id = 9', '2021-02-24 08:42:24', 'momentum_richard@localhost', 'Astra Foto', 'Astra Foto'),
(185, 'Update data dari tabel supplier, id = 7', '2021-02-24 08:42:45', 'momentum_richard@localhost', 'MLMFOTO', 'MLMFOTO'),
(186, 'Update data dari tabel supplier, id = 10', '2021-02-24 08:43:40', 'momentum_richard@localhost', 'arTechno Digital', 'arTechno Digital'),
(187, 'Update data dari tabel supplier, id = 9', '2021-02-24 08:43:56', 'momentum_richard@localhost', 'Astra Foto', 'Astra Foto'),
(188, 'Update data dari tabel supplier, id = 8', '2021-02-24 08:44:30', 'momentum_richard@localhost', 'PlayHardID', 'PlayHardID'),
(189, 'Update data dari tabel supplier, id = 6', '2021-02-24 08:45:16', 'momentum_richard@localhost', 'Cahaya Technic', 'Cahaya Technic'),
(190, 'Update data dari tabel supplier, id = 9', '2021-02-24 08:45:46', 'momentum_richard@localhost', 'Astra Foto', 'Astra Foto'),
(191, 'Update data dari tabel supplier, id = 7', '2021-02-24 08:46:57', 'momentum_richard@localhost', 'MLMFOTO', 'MLMFOTO'),
(192, 'Update data dari tabel supplier, id = 9', '2021-02-24 08:47:15', 'momentum_richard@localhost', 'Astra Foto', 'Astra Foto'),
(193, 'Update data dari tabel supplier, id = 13', '2021-02-24 08:49:45', 'momentum_richard@localhost', 'mitrakamera', 'mitrakamera'),
(194, 'Update data dari tabel supplier, id = 11', '2021-02-24 08:50:47', 'momentum_richard@localhost', 'Plaza Kamera', 'Plaza Kamera'),
(195, 'Update data dari tabel supplier, id = 11', '2021-02-24 08:51:34', 'momentum_richard@localhost', 'Plaza Kamera', 'Plaza Kamera'),
(196, 'Update data dari tabel supplier, id = 11', '2021-02-24 08:52:14', 'momentum_richard@localhost', 'Plaza Kamera', 'Plaza Kamera'),
(197, 'Update data dari tabel supplier, id = 8', '2021-02-24 08:54:46', 'momentum_richard@localhost', 'PlayHardID', 'PlayHardID'),
(198, 'Update data dari tabel supplier, id = 7', '2021-02-24 08:55:50', 'momentum_richard@localhost', 'MLMFOTO', 'MLMFOTO'),
(199, 'Update data dari tabel supplier, id = 13', '2021-02-24 08:59:14', 'momentum_richard@localhost', 'mitrakamera', 'mitrakamera'),
(200, 'Update data dari tabel supplier, id = 12', '2021-02-24 09:02:30', 'momentum_richard@localhost', 'Pixmix', 'Pixmix'),
(201, 'Update data dari tabel barang, id = 8', '2021-02-24 09:10:52', 'momentum@localhost', 'Video LED', 'Video LED'),
(202, 'Update data dari tabel barang, id = 10', '2021-02-24 09:11:47', 'momentum@localhost', 'Kain Green Screen', 'Kain Green Screen'),
(203, 'Update data dari tabel barang, id = 11', '2021-02-24 09:12:21', 'momentum@localhost', 'Lampu Studio Softbox', 'Lampu Studio Softbox'),
(204, 'Update data dari tabel barang, id = 12', '2021-02-24 09:13:40', 'momentum@localhost', 'Teleprompter', 'Teleprompter'),
(205, 'Update data dari tabel barang, id = 13', '2021-02-24 09:14:02', 'momentum@localhost', 'Tether Tools/Case Relay Camera', 'Tether Tools/Case Relay Camera'),
(206, 'Update data dari tabel barang, id = 14', '2021-02-24 09:14:21', 'momentum@localhost', 'Light Stand', 'Light Stand'),
(207, 'Update data dari tabel barang, id = 15', '2021-02-24 09:14:36', 'momentum@localhost', 'Klip Jepit Backdrop', 'Klip Jepit Backdrop'),
(208, 'Insert data ke tabel supplier, id = 15', '2021-02-24 09:15:52', 'momentum_richard@localhost', '', 'go kios online'),
(209, 'Update data dari tabel barang, id = 21', '2021-02-24 09:16:39', 'momentum@localhost', 'Busa Peredam', 'Busa Peredam'),
(210, 'Update data dari tabel barang, id = 27', '2021-02-24 09:17:49', 'momentum@localhost', 'Kain Green Screen', 'Kain Green Screen'),
(211, 'Update data dari tabel barang, id = 30', '2021-02-24 09:18:27', 'momentum@localhost', 'Meja Kerja', 'Meja Kerja'),
(212, 'Update data dari tabel barang, id = 43', '2021-02-24 09:19:08', 'momentum@localhost', 'Swivel with Wall Plate', 'Swivel with Wall Plate'),
(213, 'Update data dari tabel barang, id = 22', '2021-02-24 10:48:19', 'momentum@localhost', 'Mic Studio', 'Mic Studio'),
(214, 'Insert data ke tabel supplier, id = 16', '2021-02-24 11:03:38', 'momentum_richard@localhost', '', 'Toko Sejati'),
(215, 'Update data dari tabel barang, id = 7', '2021-02-24 11:04:16', 'momentum@localhost', 'Lampu LED 14W', 'Lampu LED 14W'),
(216, 'Insert data ke tabel supplier, id = 17', '2021-02-24 11:18:16', 'momentum_richard@localhost', '', 'Six Store'),
(217, 'Update data dari tabel barang, id = 53', '2021-02-24 11:18:57', 'momentum@localhost', 'Tripod', 'Tripod'),
(218, 'Insert data ke tabel supplier, id = 18', '2021-02-24 11:20:40', 'momentum_richard@localhost', '', 'BRAKET LED TV.'),
(219, 'Update data dari tabel barang, id = 41', '2021-02-24 11:21:31', 'momentum@localhost', 'Bracket TV', 'Bracket TV'),
(220, 'Insert data ke tabel supplier, id = 19', '2021-02-24 11:22:49', 'momentum_richard@localhost', '', 'Ko Jaz Elektronik'),
(221, 'Update data dari tabel barang, id = 42', '2021-02-24 11:23:12', 'momentum@localhost', 'Bracket TV', 'Bracket TV'),
(222, 'Insert data ke tabel supplier, id = 20', '2021-02-24 11:26:19', 'momentum_richard@localhost', '', 'hwthinker'),
(223, 'Update data dari tabel barang, id = 26', '2021-02-24 11:27:27', 'momentum@localhost', 'HDMI Capture Card', 'HDMI Capture Video Card'),
(224, 'Update data dari tabel barang, id = 45', '2021-02-24 11:43:34', 'momentum@localhost', 'Macbook Pro 2011', 'Macbook Pro 2011 15\"'),
(225, 'Update data dari tabel barang, id = 5', '2021-02-24 11:47:53', 'momentum@localhost', 'Laptop', 'Laptop Programmer'),
(226, 'Insert data ke tabel supplier, id = 21', '2021-02-24 11:56:04', 'momentum_richard@localhost', '', 'toko budget'),
(227, 'Update data dari tabel barang, id = 33', '2021-02-24 11:57:02', 'momentum@localhost', 'Mini Keyboard', 'Mini Keyboard'),
(228, 'Update data dari tabel barang, id = 34', '2021-02-24 11:57:02', 'momentum@localhost', 'Kabel Adapter HDMI to VGA', 'Kabel Adapter HDMI to VGA'),
(229, 'Insert data ke tabel user, id = 4', '2021-03-08 08:19:42', 'momentum_richard@localhost', '', 'Junifar'),
(230, 'Insert data ke tabel jabatan, id = 13', '2021-03-09 04:11:18', 'momentum_richard@localhost', '', 'Staf Data and Research'),
(231, 'Insert data ke tabel jabatan, id = 14', '2021-03-09 04:12:24', 'momentum_richard@localhost', '', 'Kepala Admin'),
(232, 'Update data dari tabel barang, id = 11', '2021-03-16 04:50:08', 'momentum_richard@localhost', 'Lampu Studio Softbox', 'Softbox Studio'),
(233, 'Insert data ke tabel supplier, id = 22', '2021-03-16 05:08:14', 'momentum_richard@localhost', '', 'Toko Delapan'),
(234, 'Insert data ke tabel barang, id = 54', '2021-03-16 05:10:22', 'momentum_richard@localhost', '', 'LED Lamp'),
(235, 'Update data dari tabel barang, id = 7', '2021-03-16 05:11:29', 'momentum_richard@localhost', 'Lampu LED 14W', 'LED Lamp'),
(236, 'Update data dari tabel barang, id = 7', '2021-03-16 08:35:58', 'momentum_richard@localhost', 'LED Lamp', 'LED Lamp'),
(237, 'Update data dari tabel barang, id = 51', '2021-03-16 08:38:57', 'momentum_richard@localhost', 'Android TV', 'Android TV'),
(238, 'Update data dari tabel user, id = 2', '2021-03-16 08:47:10', 'momentum_richard@localhost', 'Frido', 'Frido'),
(239, 'Update data dari tabel user, id = 3', '2021-03-16 08:47:26', 'momentum_richard@localhost', 'Wikantono', 'Wikantono'),
(240, 'Update data dari tabel user, id = 4', '2021-03-16 08:47:42', 'momentum_richard@localhost', 'Junifar', 'Junifar'),
(241, 'Update data dari tabel user, id = 1', '2021-03-16 08:48:10', 'momentum_richard@localhost', 'Richard', 'Richard'),
(242, 'Insert data ke tabel jabatan, id = 15', '2021-03-17 07:07:45', 'momentum_richard@localhost', '', 'Staf Legal');
...
CREATE TABLE `perbaikan` (
  ...
  `jenis_perbaikan` enum('maintenance','human error') NOT NULL,
  `harga` int(15) NOT NULL,
  `tanggal` datetime NOT NULL DEFAULT current_timestamp(),
  `tanggal_selesai` date NOT NULL,
  `contact_person` varchar(255) NOT NULL,
  `no_contact_person` char(15) NOT NULL,
  `id_barang` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `supplier` (
  `id_supplier` int(11) NOT NULL,
  `kode_supplier` char(50) NOT NULL,
  ...
  `contact_person` varchar(255) NOT NULL,
  `no_contact_person` char(14) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `supplier` (`id_supplier`, `kode_supplier`, `nama_supplier`, `alamat`, `kota`, `telepon`, `bank`, `no_rek`, `contact_person`, `no_contact_person`) VALUES
(1, 'SUP-001', 'Focus', 'BG Junction L2-B1, Jln. Bubutan I - 7', 'Surabaya', '03171558055', 'BCA', '5120238282', 'Haimanto', '08123226125'),
(2, 'SUP-002', 'Toko Hartono', 'Jln. Pucang Anom 48A', 'Surabaya', '0315024730', '', '', '', ''),
(3, 'SUP-003', 'Prologic Computer', 'Jln. Kendalsari RK-56, Ruko Nirwana Regency', 'Surabaya', '085103988881', '', '', '', ''),
(4, 'SUP-004', 'Beverly Hills Cellular', 'Plasa Marina Lt. 3 R.M3-4', 'Surabaya', '0318498505', '', '', '', ''),
(5, 'SUP-005', 'Surya Agung', 'Jln. Raya Rungkut Tengah 72', 'Surabaya', '082131257777', '', '', '', ''),
(6, 'SUP-006', 'Cahaya Technic', 'Dukuh Pakis, 60225', 'Surabaya', '', '', '', '', ''),
(7, 'SUP-007', 'MLMFOTO', 'Sawah Besar, 10710', 'Jakarta Pusat', '085780070729', '', '', '', ''),
(8, 'SUP-008', 'PlayHardID', 'Gubeng, 60285', 'Surabaya', '081908180186', '', '', '', ''),
(9, 'SUP-009', 'Astra Foto', 'ITC Mangga Dua Lantai 2 Blok C/93, Pademangan, 14240', 'Jakarta Utara', '087779858502', '', '', '', ''),
(10, 'SUP-010', 'arTechno Digital', 'Comal, Kab. Pemalang, 52363', 'Pemalang', '083123602425', '', '', '', ''),
(11, 'SUP-011', 'Plaza Kamera', 'Jl. Mangkunegoro 11, Wonokromo, 60241', 'Surabaya', '0315670009', '', '', '', '082312310100'),
(12, 'SUP-012', 'Pixmix', 'Online shop via Tokopedia', 'Surabaya', '082133388843', '', '', '', ''),
(13, 'SUP-013', 'mitrakamera', 'ITC Permata Hijau\r\nKebayoran Lama, 12210', 'Jakarta Selatan', '081317504104', '', '', '', ''),
(14, 'SUP-014', 'tech_market', 'Online shop via Shopee', 'Surabaya', '', 'BCA', '6720368313', 'Kaidin Supriono', ''),
(15, 'SUP-015', 'go kios online', 'Online shop via Tokopedia', 'Surabaya', '', '', '', '', ''),
(16, 'SUP-016', 'Toko Sejati', 'Jln. Ngagel Jaya Selatan 160', 'Surabaya', '0315017754', '', '', '', ''),
(17, 'SUP-017', 'Six Store', 'Jln. Usman Sadar 111', 'Gresik', '081113514561', 'BCA', '1500785469', '', ''),
(18, 'SUP-018', 'BRAKET LED TV.', 'Makasar, 13650', 'Jakarta TImur', '', '', '', '', ''),
(19, 'SUP-019', 'Ko Jaz Elektronik', 'Sukomanunggal, 60181', 'Surabaya', '', '', '', '', ''),
(20, 'SUP-020', 'hwthinker', 'Sukolilo', 'Surabaya', '', '', '', '', ''),
(21, 'SUP-021', 'toko budget', 'Grogol, 11450', 'Jakarta Barat', '', '', '', '', ''),
(22, 'SUP-022', 'Toko Delapan', 'Jln. Raya Wonorejo Permai RK-8', 'Surabaya', '0318715262', '', '', '', '');

--
-- Triggers `supplier`
--
DELIMITER $$
CREATE TRIGGER `after_insert_sup` AFTER INSERT ON `supplier` FOR EACH ROW BEGIN
  INSERT INTO log (ket, user, new_data)
  VALUES (CONCAT('Insert data ke tabel supplier, id = ', NEW.id_supplier), USER(),NEW.nama_supplier);
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `after_update_sup` AFTER UPDATE ON `supplier` FOR EACH ROW BEGIN
  INSERT INTO log (ket, user, new_data, old_data)
  VALUES (CONCAT('Update data dari tabel supplier, id = ', NEW.id_supplier), USER(), NEW.nama_supplier, old.nama_supplier);
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `before_delete_sup` BEFORE DELETE ON `supplier` FOR EACH ROW BEGIN
  INSERT INTO log (ket, user, old_data)
  VALUES (CONCAT('Delete data dari tabel supplier id = ', OLD.id_supplier), USER(), OLD.nama_supplier);
END
$$
DELIMITER ;
...
--
-- Table structure for table `tuton`
--
...
CREATE TABLE `user` (
  ...
  `role` enum('Admin','Kepala divisi') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `user` (`id_user`, `name`, `username`, `password`, `email`, `telepon`, `role`) VALUES
(1, 'Richard', 'masterdata', 'password#789', 'richardputras1994@gmail.com', '085101768753', 'Admin'),
(2, 'Frido', 'finance', 'gaktau', 'fridhomarguidho@gmail.com', '082140675596', 'Kepala divisi'),
(3, 'Wikantono', 'creative', 'adapassword', '', '', 'Kepala divisi'),
(4, 'Junifar', 'research', 'gakperlu', 'junifarrizkydharmawan@gmail.com', '083831111924', 'Admin');
...
CREATE TRIGGER `after_insert_user` AFTER INSERT ON `user` FOR EACH ROW BEGIN
  INSERT INTO log (ket, user, new_data)
  VALUES (CONCAT('Insert data ke tabel user, id = ', NEW.id_user), USER(), NEW.name);
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `after_update_user` AFTER UPDATE ON `user` FOR EACH ROW BEGIN
  INSERT INTO log (ket, user, new_data, old_data)
  VALUES (CONCAT('Update data dari tabel user, id = ', NEW.id_user), USER(), NEW.name, old.name);
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `before_delete_user` BEFORE DELETE ON `user` FOR EACH ROW BEGIN
  INSERT INTO log (ket, user, old_data)
  VALUES (CONCAT('Delete data dari tabel user id = ', OLD.id_user), USER(), OLD.name);
END
$$
DELIMITER ;
...
ALTER TABLE `barang`
  ...
  ADD KEY `barang_ibfk_3` (`id_pemegang`);
...
ALTER TABLE `karyawan`
  ...
  ADD KEY `karyawan_ibfk_5` (`id_jabatan`);
...
--
-- AUTO_INCREMENT for table `tuton`
--
ALTER TABLE `tuton`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `barang`
  ...
  ADD CONSTRAINT `barang_ibfk_3` FOREIGN KEY (`id_pemegang`) REFERENCES `karyawan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `karyawan`
  ADD CONSTRAINT `karyawan_ibfk_1` FOREIGN KEY (`provinsi`) REFERENCES `provinsi` (`id_prov`),
  ADD CONSTRAINT `karyawan_ibfk_2` FOREIGN KEY (`kabupaten`) REFERENCES `kabupaten` (`id_kab`),
  ADD CONSTRAINT `karyawan_ibfk_3` FOREIGN KEY (`kecamatan`) REFERENCES `kecamatan` (`id_kec`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `karyawan_ibfk_4` FOREIGN KEY (`id_jabatan`) REFERENCES `jabatan` (`id_jabatan`) ON DELETE CASCADE ON UPDATE CASCADE;
