              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h3>Data Kebutuhan HRD</h3>
                    <a href="form_pengajuan.php">Kembali</a>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover" id="table-pengajuan">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td align="center"><?php echo $row['qty']; ?></a></td>
