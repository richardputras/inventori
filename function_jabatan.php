...
if ($_GET['act'] == 'addjabatan') {
    ...
    $querytambah =  mysqli_query($koneksi, "INSERT INTO jabatan SET nama_jabatan='$namajbt', divisi='$divisi', job_desc='$desc', status_kerja='$status', gaji_pokok='$gaji', tgl_gaji='$tgl_gaji', kenaikan_gaji='$naik_gaji', tgl_naik_gaji='$tgl_naik_gaji', id_departemen ='$kode' ");
    if ($querytambah) {
    ...
    $queryupdate =  mysqli_query($koneksi, "UPDATE jabatan SET nama_jabatan='$namajbt', divisi='$divisi', job_desc='$desc', gaji_pokok='$gaji', tgl_gaji='$tgl_gaji' WHERE id_jabatan='$idjbt' ");
    if ($queryupdate) {
